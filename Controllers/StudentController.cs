...
namespace LearningManagementSystem.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(IInstructorServices instructorService, IStudentServices studentService, IDepartmentServices departmentService, ICourseServices courseService, IWebHostEnvironment webHostEnvironment)
        {
